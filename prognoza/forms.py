...
class PrognozaForm(forms.Form):
    gly = forms.FloatField(label='Blood glucose level (mmol/l)', min_value=3.7, max_value=10.5)
    krea = forms.FloatField(label='Creatinine (μmol/l)', min_value=55.0, max_value=126.0)
    tc = forms.FloatField(label='Total cholesterol (mmol/l)', min_value=2.5, max_value=6.8)
    ldl = forms.FloatField(label='Low density cholesterol (mmol/l)', min_value=1.02, max_value=4.6)
